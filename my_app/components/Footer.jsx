          ...
          <Flex gap="2rem" lggap="3rem" color="var(--clr-dark-desaturated-cyan)">
            ...
            <Container maxWidth="17rem" width="100%">
              <Flex direction="row" justify="space-between">
                  <Link href="/" ><Icon as="p" color="inherit" hcolor="var(--clr-white)">About</Icon></Link>
                  <Link href="/" ><Icon as="p" color="inherit" hcolor="var(--clr-white)">Services</Icon></Link>
                  <Link href="/" ><Icon as="p" color="inherit" hcolor="var(--clr-white)">Projects</Icon></Link>
              </Flex>
            </Container>

            <Container maxWidth="10rem" width="100%" padding="3rem 0 0 0">
              <Flex direction="row" justify="space-between">
                  <Link href="/" ><Icon color="inherit" hcolor="var(--clr-white)"><FaFacebookSquare style={{fontSize:"1.25rem"}}/></Icon></Link>
                  <Link href="/" ><Icon color="inherit" hcolor="var(--clr-white)"><FaInstagram style={{fontSize:"1.25rem"}}/></Icon></Link>
                  <Link href="/" ><Icon color="inherit" hcolor="var(--clr-white)"><FaTwitter style={{fontSize:"1.25rem"}}/></Icon></Link>
                  <Link href="/" ><Icon color="inherit" hcolor="var(--clr-white)"><FaPinterest style={{fontSize:"1.25rem"}}/></Icon></Link>
              </Flex>
            </Container>
